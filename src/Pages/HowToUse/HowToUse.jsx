    ...
    <div className="howToUseContainer">
      ...
      <div className="leftSideInfo">
        ...
        <p className="text" style={{ width: "50%", float: "left" }}>
          ...
          lowest income levels. It is a progressive taxation system where you as
          a user control the <b>marginal rate of taxation</b> for five different
          income brackets.
        </p>
      </div>
      <div className="rightSideInfo">
        ...
        <p className="text" style={{ width: "50%", float: "right" }}>
          ...
          taxes as your income increases and a portion of your income moves into
          a higher tax bracket.
          <br></br>
          <br></br>
          <b>For example</b>, if the tax rate is set to 10% for incomes between
          100-1K per day, and 15% for incomes between 1K-10K per day, then a
          person with a daily income of $8 K will pay 10 percent in taxes on
          income up to $1K and 15 % on the remaining $7K that falls into the 15
          % bracket.
        </p>
      </div>
      <div className="leftSideInfo">
      ...
      <div className="rightSideInfo">
        ...
        <p className="text" style={{ width: "50%", float: "right" }}>
          ...
          wealth distribution. You can switch between the two vizualisations by
          toggling the title on the y-axis. When <b>Population</b> is toggled,
          the chart shows the number of people that has a specific income of
          $/day. When <b>Income Accumulation</b> is toggled, the chart shows the
          precentage of total income (per day) which a specific income per day
          is.
        </p>
      </div>
